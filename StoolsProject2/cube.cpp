...
bool Cube::Initialize(float l, float w, float h)
{
	...
	fdR.position = vec3(l,0,0);
	bdL.position = vec3(0,w,0);
	fuL.position = vec3(0,0,h);
	buR.position = vec3(l,w,h);
	buL.position = vec3(0,w,h);
	fuR.position = vec3(l,0,h);
	bdR.position = vec3(l,w,0);
