...
bool Square::Initialize(int x, float s)
{
	...
	for (int i = 0; i < x; ++i)
	{
		for (int j = 0; j < x; ++j)
		{
			...
			if(checker%2 == 0){
				cur_vertex.color = color1;
				dwn_vertex.color = color1;
				dwr_vertex.color = color1;
				nxt_vertex.color = color1;
			}
			else{
				cur_vertex.color = color2;
				dwn_vertex.color = color2;
				dwr_vertex.color = color2;
				nxt_vertex.color = color2;
			}
